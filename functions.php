 ...
 *
 */
    $enough_nav_menus_location = array(
 ...
 *
 */
    register_nav_menus( $enough_nav_menus_location );
 ...
 *
 */
    if(!function_exists("enough_nav_menu")){
        function enough_nav_menu($args,$display = true){
    ...
    */
    ?>
        function fontResize(){
            ...
            var body_class = width / 100;
            body_class = Math.floor(body_class);
            body_class = body_class * 100;
            ...
            jQuery('body').addClass("width"+body_class);
 ...
 *
 */
        $install_once = get_option('enough_theme_settings');

        if ($install_once == false or !array_key_exists('install', $install_once) ) {
            add_action('admin_init', 'setup_enough');
        }
/**
 ...
 *
 */
    if(!function_exists("setup_enough")){
        function setup_enough(){
 ...
 */
        ...
        function enough_twitter_id_validate($input){
 ...
 * @subpackage enough
 */
        $is_submenu = new enough_menu_create;
...
if(!function_exists('enough_embed_iphone_device_width')){
    ...
    <meta name="viewport" content="width=<?php echo $enough_embed_iphone_device_width; ?>" />
